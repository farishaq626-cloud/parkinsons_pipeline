...
* **Stress Testing Suite**: A dedicated module (`stress_test.py`) that simulates real-world corrupted data entry to verify that the pipeline fails gracefully with clear diagnostic feedback.

## Technical Highlights

* **Defensive Programming**: Utilizes explicit data type coercion (`pd.to_numeric`) to maintain system stability when encountering non-standard data types.
