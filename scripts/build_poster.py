...
the compiler output in ``poster/build/`` for diagnosis.
"""
...
def main() -> int:
    ...
    if missing_themes:
        ...
        print(
            "Place the Gemini theme files in poster/, then rerun: "
    ...
    if engine is None:
        ...
        print(
            ...
            "then rerun: python scripts/build_poster.py. Alternatively, upload "
            "poster/poster.tex "
