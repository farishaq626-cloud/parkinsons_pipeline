...
from ppmi_pipeline.config import MODELING_RESULTS_DIR
from ppmi_pipeline.exceptions import DataFileNotFoundError, MissingColumnError

from .real_run import load_real_run_provenance
    ...
    for report_key, filename in report_names.items():
        ...
        if not report_path.exists():
            raise DataFileNotFoundError(
                ...
                "Run ppmi-pipeline before generating poster figures."
            )
